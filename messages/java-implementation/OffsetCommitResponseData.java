...
public class OffsetCommitResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            new Field("topics", new ArrayOf(OffsetCommitResponseTopic.SCHEMA_2), "The responses for each topic.")
        );
    ...
    public static class OffsetCommitResponseTopic implements Message {
        ...
        public static final Schema SCHEMA_2 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(OffsetCommitResponsePartition.SCHEMA_2), "The responses for each partition in the topic.")
            );

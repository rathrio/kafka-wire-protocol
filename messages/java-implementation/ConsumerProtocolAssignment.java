...
public class ConsumerProtocolAssignment implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("assigned_partitions", new ArrayOf(TopicPartition.SCHEMA_0), "The list of topics and partitions assigned to this consumer."),
            new Field("user_data", Type.NULLABLE_BYTES, "User data.")
        );
    ...
    public static class TopicPartition implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(Type.INT32), "The list of partitions assigned to this consumer.")
            );

...
public class ShareAcknowledgeResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("responses", new CompactArrayOf(ShareAcknowledgeTopicResponse.SCHEMA_0), "The response topics."),
    ...
    public ShareAcknowledgeResponseData(Readable _readable, short _version) {
    ...
    public ShareAcknowledgeResponseData() {
        ...
        this.responses = new ArrayList<ShareAcknowledgeTopicResponse>(0);
    ...
    public final void read(Readable _readable, short _version) {
        ...
        }
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<ShareAcknowledgeTopicResponse> newCollection = new ArrayList<>(arrayLength);
                for (int i = 0; i < arrayLength; i++) {
                    newCollection.add(new ShareAcknowledgeTopicResponse(_readable, _version));
                }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        for (ShareAcknowledgeTopicResponse responsesElement : responses) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ShareAcknowledgeResponseData)) return false;
        ShareAcknowledgeResponseData other = (ShareAcknowledgeResponseData) obj;
    ...
    public ShareAcknowledgeResponseData duplicate() {
        ShareAcknowledgeResponseData _duplicate = new ShareAcknowledgeResponseData();
        ...
        ArrayList<ShareAcknowledgeTopicResponse> newResponses = new ArrayList<ShareAcknowledgeTopicResponse>(responses.size());
        for (ShareAcknowledgeTopicResponse _element : responses) {
    ...
    public ShareAcknowledgeResponseData setThrottleTimeMs(int v) {
        this.throttleTimeMs = v;
        return this;
    }
    
    public ShareAcknowledgeResponseData setErrorCode(short v) {
        this.errorCode = v;
        return this;
    }
    
    public ShareAcknowledgeResponseData setErrorMessage(String v) {
        this.errorMessage = v;
        return this;
    }
    
    public ShareAcknowledgeResponseData setResponses(List<ShareAcknowledgeTopicResponse> v) {
        this.responses = v;
        return this;
    }
    
    public ShareAcknowledgeResponseData setNodeEndpoints(NodeEndpointCollection v) {
    ...
    public static class ShareAcknowledgeTopicResponse implements Message {
        ...
        public ShareAcknowledgeTopicResponse(Readable _readable, short _version) {
            read(_readable, _version);
        }
        ...
        public final void read(Readable _readable, short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of ShareAcknowledgeTopicResponse");
            }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of ShareAcknowledgeTopicResponse");
            }
            _size.addBytes(16);
            {
        ...
        @Override
        public boolean equals(Object obj) {
            if (!(obj instanceof ShareAcknowledgeTopicResponse)) return false;
            ShareAcknowledgeTopicResponse other = (ShareAcknowledgeTopicResponse) obj;
        ...
        public ShareAcknowledgeTopicResponse duplicate() {
            ShareAcknowledgeTopicResponse _duplicate = new ShareAcknowledgeTopicResponse();
        ...
        public ShareAcknowledgeTopicResponse setTopicId(Uuid v) {
            this.topicId = v;
            return this;
        }
        
        public ShareAcknowledgeTopicResponse setPartitions(List<PartitionData> v) {
            this.partitions = v;
            return this;
        }
    }

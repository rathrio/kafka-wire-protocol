...
public class WriteShareGroupStateResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("results", new CompactArrayOf(WriteStateResult.SCHEMA_0), "The write results."),
    ...
    public WriteShareGroupStateResponseData(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public WriteShareGroupStateResponseData() {
        this.results = new ArrayList<WriteStateResult>(0);
    }
    ...
    public final void read(Readable _readable, short _version) {
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<WriteStateResult> newCollection = new ArrayList<>(arrayLength);
                for (int i = 0; i < arrayLength; i++) {
                    newCollection.add(new WriteStateResult(_readable, _version));
                }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        for (WriteStateResult resultsElement : results) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof WriteShareGroupStateResponseData)) return false;
        WriteShareGroupStateResponseData other = (WriteShareGroupStateResponseData) obj;
    ...
    public WriteShareGroupStateResponseData duplicate() {
        WriteShareGroupStateResponseData _duplicate = new WriteShareGroupStateResponseData();
        ArrayList<WriteStateResult> newResults = new ArrayList<WriteStateResult>(results.size());
        for (WriteStateResult _element : results) {
    ...
    public WriteShareGroupStateResponseData setResults(List<WriteStateResult> v) {
        this.results = v;
        return this;
    }
    ...
    public static class WriteStateResult implements Message {
        ...
        public WriteStateResult(Readable _readable, short _version) {
            read(_readable, _version);
        }
        ...
        public final void read(Readable _readable, short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of WriteStateResult");
            }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of WriteStateResult");
            }
            _size.addBytes(16);
            {
        ...
        @Override
        public boolean equals(Object obj) {
            if (!(obj instanceof WriteStateResult)) return false;
            WriteStateResult other = (WriteStateResult) obj;
        ...
        public WriteStateResult duplicate() {
            WriteStateResult _duplicate = new WriteStateResult();
        ...
        public WriteStateResult setTopicId(Uuid v) {
            this.topicId = v;
            return this;
        }
        
        public WriteStateResult setPartitions(List<PartitionResult> v) {
            this.partitions = v;
            return this;
        }
    }

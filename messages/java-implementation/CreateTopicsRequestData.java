...
public class CreateTopicsRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            new Field("topics", new ArrayOf(CreatableTopic.SCHEMA_2), "The topics to create."),
    ...
    public static class CreatableTopic implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_2 =
            new Schema(
                ...
                new Field("assignments", new ArrayOf(CreatableReplicaAssignment.SCHEMA_2), "The manual partition assignment, or the empty array if we are using automatic assignment."),
                new Field("configs", new ArrayOf(CreatableTopicConfig.SCHEMA_2), "The custom topic configurations to set.")
            );
        ...
        public static final Schema SCHEMA_5 =
            new Schema(
                ...
                new Field("configs", new CompactArrayOf(CreatableTopicConfig.SCHEMA_5), "The custom topic configurations to set."),
                TaggedFieldsSection.of(
                )
            );
        ...
        public CreatableTopic() {
            ...
            this.configs = new CreatableTopicConfigCollection(0);
            this.prev = ImplicitLinkedHashCollection.INVALID_INDEX;
            this.next = ImplicitLinkedHashCollection.INVALID_INDEX;
        }
            ...
            }
            {
                if (_version >= 5) {
                    ...
                    if (arrayLength < 0) {
                        ...
                        CreatableTopicConfigCollection newCollection = new CreatableTopicConfigCollection(arrayLength);
                        for (int i = 0; i < arrayLength; i++) {
                            newCollection.add(new CreatableTopicConfig(_readable, _version));
                        }
        ...
        public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
            ...
            if (_version >= 5) {
                ...
                for (CreatableTopicConfig configsElement : configs) {
        ...
        public CreatableTopic duplicate() {
            ...
            CreatableTopicConfigCollection newConfigs = new CreatableTopicConfigCollection(configs.size());
            for (CreatableTopicConfig _element : configs) {
        ...
        public CreatableTopicConfigCollection configs() {
            return this.configs;
        }
        ...
        public CreatableTopic setConfigs(CreatableTopicConfigCollection v) {
            this.configs = v;
            return this;
        }
    ...
    public static class CreatableTopicConfig implements Message, ImplicitLinkedHashMultiCollection.Element {
        String name;
        String value;
        private List<RawTaggedField> _unknownTaggedFields;
        private int next;
        ...
        public CreatableTopicConfig(Readable _readable, short _version) {
            read(_readable, _version);
            this.prev = ImplicitLinkedHashCollection.INVALID_INDEX;
            this.next = ImplicitLinkedHashCollection.INVALID_INDEX;
        }
        
        public CreatableTopicConfig() {
            this.name = "";
            this.value = "";
            this.prev = ImplicitLinkedHashCollection.INVALID_INDEX;
            this.next = ImplicitLinkedHashCollection.INVALID_INDEX;
        ...
        public final void read(Readable _readable, short _version) {
            if ((_version < 2) || (_version > 7)) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of CreatableTopicConfig");
            }
            {
                int length;
                if (_version >= 5) {
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if ((_version < 2) || (_version > 7)) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of CreatableTopicConfig");
            }
            {
                byte[] _stringBytes = name.getBytes(StandardCharsets.UTF_8);
                if (_stringBytes.length > 0x7fff) {
        ...
        @Override
        public boolean elementKeysAreEqual(Object obj) {
            if (!(obj instanceof CreatableTopicConfig)) return false;
            CreatableTopicConfig other = (CreatableTopicConfig) obj;
            if (this.name == null) {
                if (other.name != null) return false;
            } else {
                if (!this.name.equals(other.name)) return false;
        ...
        @Override
        public CreatableTopicConfig duplicate() {
            CreatableTopicConfig _duplicate = new CreatableTopicConfig();
            _duplicate.name = name;
            if (value == null) {
        ...
        public CreatableTopicConfig setName(String v) {
            this.name = v;
            return this;
        }
        
        public CreatableTopicConfig setValue(String v) {
            this.value = v;
            return this;
        }
    ...
    public static class CreatableTopicConfigCollection extends ImplicitLinkedHashMultiCollection<CreatableTopicConfig> {
        public CreatableTopicConfigCollection() {
            super();
        }
        
        public CreatableTopicConfigCollection(int expectedNumElements) {
            super(expectedNumElements);
        }
        
        public CreatableTopicConfigCollection(Iterator<CreatableTopicConfig> iterator) {
            super(iterator);
        }
        
        public CreatableTopicConfig find(String name) {
            CreatableTopicConfig _key = new CreatableTopicConfig();
            _key.setName(name);
            return find(_key);
        }
        
        public List<CreatableTopicConfig> findAll(String name) {
            CreatableTopicConfig _key = new CreatableTopicConfig();
            _key.setName(name);
            return findAll(_key);
        }
        
        public CreatableTopicConfigCollection duplicate() {
            CreatableTopicConfigCollection _duplicate = new CreatableTopicConfigCollection(size());
            for (CreatableTopicConfig _element : this) {
                _duplicate.add(_element.duplicate());
            }
            return _duplicate;
        }

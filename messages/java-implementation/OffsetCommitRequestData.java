...
public class OffsetCommitRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            ...
            new Field("generation_id_or_member_epoch", Type.INT32, "The generation of the group if using the classic group protocol or the member epoch if using the consumer protocol."),
    ...
    public OffsetCommitRequestData() {
        this.groupId = "";
        this.generationIdOrMemberEpoch = -1;
        this.memberId = "";
    ...
    public final void read(Readable _readable, short _version) {
        ...
        this.generationIdOrMemberEpoch = _readable.readInt();
        {
            int length;
            if (_version >= 8) {
                length = _readable.readUnsignedVarint() - 1;
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        _writable.writeInt(generationIdOrMemberEpoch);
        {
    ...
    public boolean equals(Object obj) {
        ...
        if (generationIdOrMemberEpoch != other.generationIdOrMemberEpoch) return false;
    ...
    public int hashCode() {
        ...
        hashCode = 31 * hashCode + generationIdOrMemberEpoch;
    ...
    public OffsetCommitRequestData duplicate() {
        ...
        _duplicate.generationIdOrMemberEpoch = generationIdOrMemberEpoch;
    ...
    public OffsetCommitRequestData setGenerationIdOrMemberEpoch(int v) {
        this.generationIdOrMemberEpoch = v;
        return this;
    }

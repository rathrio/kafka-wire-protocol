    ...
    public static final Schema SCHEMA_3 =
        new Schema(
            ...
            TaggedFieldsSection.of(
                0, new Field("supported_features", new CompactArrayOf(SupportedFeatureKey.SCHEMA_3), "Features supported by the broker. Note: in v0-v3, features with MinSupportedVersion = 0 are omitted."),

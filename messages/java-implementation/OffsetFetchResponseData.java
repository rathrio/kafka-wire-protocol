...
public class OffsetFetchResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            new Field("topics", new ArrayOf(OffsetFetchResponseTopic.SCHEMA_1), "The responses per topic.")
        );
    ...
    public static class OffsetFetchResponseTopic implements Message {
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(OffsetFetchResponsePartition.SCHEMA_1), "The responses per partition.")
            );

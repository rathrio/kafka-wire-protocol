...
public class VoteResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_0), "The results for each topic."),
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            ...
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_0), "The results for each topic."),
            TaggedFieldsSection.of(
                0, new Field("node_endpoints", new CompactArrayOf(NodeEndpoint.SCHEMA_1), "Endpoints for all current-leaders enumerated in PartitionData.")
            )
        );
    ...
    public VoteResponseData setNodeEndpoints(NodeEndpointCollection v) {
    ...
    public static class TopicData implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partitions", new CompactArrayOf(PartitionData.SCHEMA_0), "The results for each partition."),
                TaggedFieldsSection.of(
                )
            );

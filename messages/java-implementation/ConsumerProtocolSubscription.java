...
public class ConsumerProtocolSubscription implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("topics", new ArrayOf(Type.STRING), "The topics that the member wants to consume."),
            new Field("user_data", Type.NULLABLE_BYTES, "User data that will be passed back to the consumer.")
        );
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            new Field("topics", new ArrayOf(Type.STRING), "The topics that the member wants to consume."),
            new Field("user_data", Type.NULLABLE_BYTES, "User data that will be passed back to the consumer."),
            new Field("owned_partitions", new ArrayOf(TopicPartition.SCHEMA_1), "The partitions that the member owns.")
        );
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            ...
            new Field("user_data", Type.NULLABLE_BYTES, "User data that will be passed back to the consumer."),
            new Field("owned_partitions", new ArrayOf(TopicPartition.SCHEMA_1), "The partitions that the member owns."),
            new Field("generation_id", Type.INT32, "The generation id of the member.")
        );
    ...
    public static final Schema SCHEMA_3 =
        new Schema(
            ...
            new Field("owned_partitions", new ArrayOf(TopicPartition.SCHEMA_1), "The partitions that the member owns."),
            new Field("generation_id", Type.INT32, "The generation id of the member."),
            new Field("rack_id", Type.NULLABLE_STRING, "The rack id of the member.")
        );
    ...
    public static class TopicPartition implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(Type.INT32), "The partition ids.")
            );

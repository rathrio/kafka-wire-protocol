...
public class AlterReplicaLogDirsResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            ...
            new Field("results", new ArrayOf(AlterReplicaLogDirTopicResult.SCHEMA_1), "The results for each topic.")
        );
    ...
    public static class AlterReplicaLogDirTopicResult implements Message {
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(AlterReplicaLogDirPartitionResult.SCHEMA_1), "The results for each partition.")
            );

...
public class CreateTopicsRequestDataJsonConverter {
    ...
    public static class CreatableTopicJsonConverter {
        public static CreatableTopic read(JsonNode _node, short _version) {
            ...
            if (_configsNode == null) {
                ...
                CreatableTopicConfigCollection _collection = new CreatableTopicConfigCollection(_configsNode.size());
        ...
        public static JsonNode write(CreatableTopic _object, short _version, boolean _serializeRecords) {
            ...
            for (CreatableTopicConfig _element : _object.configs) {
    ...
    public static class CreatableTopicConfigJsonConverter {
        public static CreatableTopicConfig read(JsonNode _node, short _version) {
            CreatableTopicConfig _object = new CreatableTopicConfig();
            JsonNode _nameNode = _node.get("name");
            if (_nameNode == null) {
                throw new RuntimeException("CreatableTopicConfig: unable to locate field 'name', which is mandatory in version " + _version);
            } else {
                if (!_nameNode.isTextual()) {
                    throw new RuntimeException("CreatableTopicConfig expected a string type, but got " + _node.getNodeType());
                }
                _object.name = _nameNode.asText();
            }
        ...
        public static JsonNode write(CreatableTopicConfig _object, short _version, boolean _serializeRecords) {
            ObjectNode _node = new ObjectNode(JsonNodeFactory.instance);
            _node.set("name", new TextNode(_object.name));
        ...
        public static JsonNode write(CreatableTopicConfig _object, short _version) {
            return write(_object, _version, true);
        }
    }
}

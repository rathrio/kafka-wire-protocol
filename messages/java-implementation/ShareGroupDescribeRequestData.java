...
public class ShareGroupDescribeRequestData implements ApiMessage {
    ...
    public ShareGroupDescribeRequestData(Readable _readable, short _version) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ShareGroupDescribeRequestData)) return false;
    ...
    public String toString() {
        return "ShareGroupDescribeRequestData("

...
public class InitializeShareGroupStateRequestData implements ApiMessage {
    String groupId;
    List<InitializeStateData> topics;
    private List<RawTaggedField> _unknownTaggedFields;
    
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("group_id", Type.COMPACT_STRING, "The group identifier."),
            new Field("topics", new CompactArrayOf(InitializeStateData.SCHEMA_0), "The data for the topics."),
    ...
    public InitializeShareGroupStateRequestData(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public InitializeShareGroupStateRequestData() {
        this.groupId = "";
        this.topics = new ArrayList<InitializeStateData>(0);
    }
    ...
    public final void read(Readable _readable, short _version) {
        ...
        }
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<InitializeStateData> newCollection = new ArrayList<>(arrayLength);
                for (int i = 0; i < arrayLength; i++) {
                    newCollection.add(new InitializeStateData(_readable, _version));
                }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        for (InitializeStateData topicsElement : topics) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof InitializeShareGroupStateRequestData)) return false;
        InitializeShareGroupStateRequestData other = (InitializeShareGroupStateRequestData) obj;
    ...
    @Override
    public InitializeShareGroupStateRequestData duplicate() {
        InitializeShareGroupStateRequestData _duplicate = new InitializeShareGroupStateRequestData();
        _duplicate.groupId = groupId;
        ArrayList<InitializeStateData> newTopics = new ArrayList<InitializeStateData>(topics.size());
        for (InitializeStateData _element : topics) {
    ...
    public List<InitializeStateData> topics() {
        return this.topics;
    }
    ...
    public InitializeShareGroupStateRequestData setGroupId(String v) {
        this.groupId = v;
        return this;
    }
    
    public InitializeShareGroupStateRequestData setTopics(List<InitializeStateData> v) {
        this.topics = v;
        return this;
    }
    
    public static class InitializeStateData implements Message {
        Uuid topicId;
        ...
        public InitializeStateData(Readable _readable, short _version) {
            read(_readable, _version);
        }
        
        public InitializeStateData() {
        ...
        public final void read(Readable _readable, short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of InitializeStateData");
            }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of InitializeStateData");
            }
            _size.addBytes(16);
            {
        ...
        @Override
        public boolean equals(Object obj) {
            if (!(obj instanceof InitializeStateData)) return false;
            InitializeStateData other = (InitializeStateData) obj;
        ...
        @Override
        public InitializeStateData duplicate() {
            InitializeStateData _duplicate = new InitializeStateData();
        ...
        public InitializeStateData setTopicId(Uuid v) {
            this.topicId = v;
            return this;
        }
        
        public InitializeStateData setPartitions(List<PartitionData> v) {
            this.partitions = v;
            return this;
        }
    }
    ...
    public static class PartitionData implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("start_offset", Type.INT64, "The share-partition start offset, or -1 if the start offset is not being initialized."),
                TaggedFieldsSection.of(
                )
            );

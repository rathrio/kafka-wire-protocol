    ...
    public static class PartitionResponse implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("active_producers", new CompactArrayOf(ProducerState.SCHEMA_0), "The active producers for the partition."),
                TaggedFieldsSection.of(
                )
            );
    ...
    public static class ProducerState implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("producer_epoch", Type.INT32, "The producer epoch."),
                new Field("last_sequence", Type.INT32, "The last sequence number sent by the producer."),
                new Field("last_timestamp", Type.INT64, "The last timestamp sent by the producer."),
                new Field("coordinator_epoch", Type.INT32, "The current epoch of the producer group."),
                new Field("current_txn_start_offset", Type.INT64, "The current transaction start offset of the producer."),
                TaggedFieldsSection.of(
                )
            );

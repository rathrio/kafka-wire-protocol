...
public class DescribeTransactionsResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("transaction_states", new CompactArrayOf(TransactionState.SCHEMA_0), "The current state of the transaction."),
    ...
    public static class TransactionState implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("transactional_id", Type.COMPACT_STRING, "The transactional id."),
                new Field("transaction_state", Type.COMPACT_STRING, "The current transaction state of the producer."),
                new Field("transaction_timeout_ms", Type.INT32, "The timeout in milliseconds for the transaction."),
                new Field("transaction_start_time_ms", Type.INT64, "The start time of the transaction in milliseconds."),
                new Field("producer_id", Type.INT64, "The current producer id associated with the transaction."),
    ...
    public static class TopicData implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partitions", new CompactArrayOf(Type.INT32), "The partition ids included in the current transaction."),
                TaggedFieldsSection.of(
                )
            );

...
public class ProduceRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_3 =
        new Schema(
            ...
            new Field("topic_data", new ArrayOf(TopicProduceData.SCHEMA_3), "Each topic to produce to.")
        );
    ...
    public static class TopicProduceData implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_3 =
            new Schema(
                ...
                new Field("partition_data", new ArrayOf(PartitionProduceData.SCHEMA_3), "Each partition to produce to.")
            );

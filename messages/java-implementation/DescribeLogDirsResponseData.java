...
public class DescribeLogDirsResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            ...
            new Field("results", new ArrayOf(DescribeLogDirsResult.SCHEMA_1), "The log directories.")
        );
    ...
    public static class DescribeLogDirsResult implements Message {
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                ...
                new Field("topics", new ArrayOf(DescribeLogDirsTopic.SCHEMA_1), "The topics.")
            );
        ...
        public static final Schema SCHEMA_2 =
            new Schema(
                ...
                new Field("topics", new CompactArrayOf(DescribeLogDirsTopic.SCHEMA_2), "The topics."),
                TaggedFieldsSection.of(
                )
            );
    ...
    public static class DescribeLogDirsTopic implements Message {
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                ...
                new Field("partitions", new ArrayOf(DescribeLogDirsPartition.SCHEMA_1), "The partitions.")
            );
        
        public static final Schema SCHEMA_2 =
            new Schema(
                new Field("name", Type.COMPACT_STRING, "The topic name."),
                new Field("partitions", new CompactArrayOf(DescribeLogDirsPartition.SCHEMA_2), "The partitions."),
                TaggedFieldsSection.of(
                )
            );

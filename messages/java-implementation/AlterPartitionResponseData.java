...
public class AlterPartitionResponseData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            ...
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_0), "The responses for each topic."),
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            new Field("throttle_time_ms", Type.INT32, "The duration in milliseconds for which the request was throttled due to a quota violation, or zero if the request did not violate any quota."),
            new Field("error_code", Type.INT16, "The top level response error code."),
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_1), "The responses for each topic."),
            TaggedFieldsSection.of(
            )
        );
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            new Field("throttle_time_ms", Type.INT32, "The duration in milliseconds for which the request was throttled due to a quota violation, or zero if the request did not violate any quota."),
            new Field("error_code", Type.INT16, "The top level response error code."),
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_2), "The responses for each topic."),
            TaggedFieldsSection.of(
            )
        );
    ...
    public static class TopicData implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partitions", new CompactArrayOf(PartitionData.SCHEMA_0), "The responses for each partition."),
                TaggedFieldsSection.of(
                )
            );
        ...
        public static final Schema SCHEMA_1 =
            new Schema(
                new Field("topic_name", Type.COMPACT_STRING, "The name of the topic."),
                new Field("partitions", new CompactArrayOf(PartitionData.SCHEMA_1), "The responses for each partition."),
                TaggedFieldsSection.of(
                )
            );
    ...
    public static class PartitionData implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partition_epoch", Type.INT32, "The current epoch for the partition for KRaft controllers."),
                TaggedFieldsSection.of(
                )
            );

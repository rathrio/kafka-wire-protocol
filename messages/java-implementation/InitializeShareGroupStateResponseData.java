...
public class InitializeShareGroupStateResponseData implements ApiMessage {
    List<InitializeStateResult> results;
    private List<RawTaggedField> _unknownTaggedFields;
    
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("results", new CompactArrayOf(InitializeStateResult.SCHEMA_0), "The initialization results."),
    ...
    public InitializeShareGroupStateResponseData(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public InitializeShareGroupStateResponseData() {
        this.results = new ArrayList<InitializeStateResult>(0);
    }
    ...
    public final void read(Readable _readable, short _version) {
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<InitializeStateResult> newCollection = new ArrayList<>(arrayLength);
                for (int i = 0; i < arrayLength; i++) {
                    newCollection.add(new InitializeStateResult(_readable, _version));
                }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        for (InitializeStateResult resultsElement : results) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof InitializeShareGroupStateResponseData)) return false;
        InitializeShareGroupStateResponseData other = (InitializeShareGroupStateResponseData) obj;
    ...
    @Override
    public InitializeShareGroupStateResponseData duplicate() {
        InitializeShareGroupStateResponseData _duplicate = new InitializeShareGroupStateResponseData();
        ArrayList<InitializeStateResult> newResults = new ArrayList<InitializeStateResult>(results.size());
        for (InitializeStateResult _element : results) {
    ...
    public String toString() {
        return "InitializeShareGroupStateResponseData("
            + "results=" + MessageUtil.deepToString(results.iterator())
            + ")";
    }
    
    public List<InitializeStateResult> results() {
        return this.results;
    }
    ...
    public InitializeShareGroupStateResponseData setResults(List<InitializeStateResult> v) {
        this.results = v;
        return this;
    }
    
    public static class InitializeStateResult implements Message {
        Uuid topicId;
        ...
        public InitializeStateResult(Readable _readable, short _version) {
            read(_readable, _version);
        }
        
        public InitializeStateResult() {
        ...
        public final void read(Readable _readable, short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of InitializeStateResult");
            }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of InitializeStateResult");
            }
            _size.addBytes(16);
            {
        ...
        @Override
        public boolean equals(Object obj) {
            if (!(obj instanceof InitializeStateResult)) return false;
            InitializeStateResult other = (InitializeStateResult) obj;
        ...
        @Override
        public InitializeStateResult duplicate() {
            InitializeStateResult _duplicate = new InitializeStateResult();
        ...
        public InitializeStateResult setTopicId(Uuid v) {
            this.topicId = v;
            return this;
        }
        
        public InitializeStateResult setPartitions(List<PartitionResult> v) {
            this.partitions = v;
            return this;
        }
    }

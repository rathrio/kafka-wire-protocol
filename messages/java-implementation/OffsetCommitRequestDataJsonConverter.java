...
public class OffsetCommitRequestDataJsonConverter {
    public static OffsetCommitRequestData read(JsonNode _node, short _version) {
        ...
        JsonNode _generationIdOrMemberEpochNode = _node.get("generationIdOrMemberEpoch");
        if (_generationIdOrMemberEpochNode == null) {
            throw new RuntimeException("OffsetCommitRequestData: unable to locate field 'generationIdOrMemberEpoch', which is mandatory in version " + _version);
        } else {
            _object.generationIdOrMemberEpoch = MessageUtil.jsonNodeToInt(_generationIdOrMemberEpochNode, "OffsetCommitRequestData");
        }
    ...
    public static JsonNode write(OffsetCommitRequestData _object, short _version, boolean _serializeRecords) {
        ...
        _node.set("generationIdOrMemberEpoch", new IntNode(_object.generationIdOrMemberEpoch));

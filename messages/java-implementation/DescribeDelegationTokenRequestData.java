...
public class DescribeDelegationTokenRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            new Field("owners", ArrayOf.nullable(DescribeDelegationTokenOwner.SCHEMA_1), "Each owner that we want to describe delegation tokens for, or null to describe all tokens.")
        );

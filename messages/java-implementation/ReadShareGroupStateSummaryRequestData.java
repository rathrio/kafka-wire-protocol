...
public class ReadShareGroupStateSummaryRequestData implements ApiMessage {
    String groupId;
    List<ReadStateSummaryData> topics;
    private List<RawTaggedField> _unknownTaggedFields;
    
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("group_id", Type.COMPACT_STRING, "The group identifier."),
            new Field("topics", new CompactArrayOf(ReadStateSummaryData.SCHEMA_0), "The data for the topics."),
    ...
    public ReadShareGroupStateSummaryRequestData(Readable _readable, short _version) {
        read(_readable, _version);
    }
    
    public ReadShareGroupStateSummaryRequestData() {
        this.groupId = "";
        this.topics = new ArrayList<ReadStateSummaryData>(0);
    }
    ...
    public final void read(Readable _readable, short _version) {
        ...
        }
        {
            ...
            if (arrayLength < 0) {
                ...
                ArrayList<ReadStateSummaryData> newCollection = new ArrayList<>(arrayLength);
                for (int i = 0; i < arrayLength; i++) {
                    newCollection.add(new ReadStateSummaryData(_readable, _version));
                }
    ...
    public void write(Writable _writable, ObjectSerializationCache _cache, short _version) {
        ...
        for (ReadStateSummaryData topicsElement : topics) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ReadShareGroupStateSummaryRequestData)) return false;
        ReadShareGroupStateSummaryRequestData other = (ReadShareGroupStateSummaryRequestData) obj;
    ...
    @Override
    public ReadShareGroupStateSummaryRequestData duplicate() {
        ReadShareGroupStateSummaryRequestData _duplicate = new ReadShareGroupStateSummaryRequestData();
        _duplicate.groupId = groupId;
        ArrayList<ReadStateSummaryData> newTopics = new ArrayList<ReadStateSummaryData>(topics.size());
        for (ReadStateSummaryData _element : topics) {
    ...
    public String toString() {
        return "ReadShareGroupStateSummaryRequestData("
    ...
    public List<ReadStateSummaryData> topics() {
        return this.topics;
    }
    ...
    public ReadShareGroupStateSummaryRequestData setGroupId(String v) {
        this.groupId = v;
        return this;
    }
    
    public ReadShareGroupStateSummaryRequestData setTopics(List<ReadStateSummaryData> v) {
        this.topics = v;
        return this;
    }
    
    public static class ReadStateSummaryData implements Message {
        Uuid topicId;
        ...
        public ReadStateSummaryData(Readable _readable, short _version) {
            read(_readable, _version);
        }
        
        public ReadStateSummaryData() {
        ...
        public final void read(Readable _readable, short _version) {
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't read version " + _version + " of ReadStateSummaryData");
            }
        ...
        public void addSize(MessageSizeAccumulator _size, ObjectSerializationCache _cache, short _version) {
            int _numTaggedFields = 0;
            if (_version > 0) {
                throw new UnsupportedVersionException("Can't size version " + _version + " of ReadStateSummaryData");
            }
            _size.addBytes(16);
            {
        ...
        @Override
        public boolean equals(Object obj) {
            if (!(obj instanceof ReadStateSummaryData)) return false;
            ReadStateSummaryData other = (ReadStateSummaryData) obj;
        ...
        @Override
        public ReadStateSummaryData duplicate() {
            ReadStateSummaryData _duplicate = new ReadStateSummaryData();
        ...
        public ReadStateSummaryData setTopicId(Uuid v) {
            this.topicId = v;
            return this;
        }
        
        public ReadStateSummaryData setPartitions(List<PartitionData> v) {
            this.partitions = v;
            return this;
        }
    }

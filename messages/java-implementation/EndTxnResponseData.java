...
public class EndTxnResponseData implements ApiMessage {
    ...
    public EndTxnResponseData(Readable _readable, short _version) {
    ...
    @Override
    public EndTxnResponseData duplicate() {
        EndTxnResponseData _duplicate = new EndTxnResponseData();
    ...
    public EndTxnResponseData setProducerId(long v) {
        this.producerId = v;
        return this;
    }
    
    public EndTxnResponseData setProducerEpoch(short v) {

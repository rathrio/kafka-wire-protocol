...
public class DescribeQuorumRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("topics", new CompactArrayOf(TopicData.SCHEMA_0), "The topics to describe."),
    ...
    public static class TopicData implements Message {
        ...
        public static final Schema SCHEMA_0 =
            new Schema(
                ...
                new Field("partitions", new CompactArrayOf(PartitionData.SCHEMA_0), "The partitions to describe."),
                TaggedFieldsSection.of(
                )
            );
